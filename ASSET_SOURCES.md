...
## 4. Original work (created for this project)
...
| File | What it is |
| --- | --- |
| `public/favicon.svg` | Panda brand glyph, theme-aware (inverts in dark mode) |
...
| `src/components/brand/PandaMark.tsx` | The panda glyph as a React component |
