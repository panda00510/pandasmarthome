...
export const zh: Content = {
  ...
  meta: {
    ...
    description:
      'Panda智能家居为全新加坡的组屋、预购组屋、公寓与有地住宅提供智能家居设计与安装。灯光、空调、窗帘、门锁与摄像头接入同一套本地系统，不绑定单一品牌。',
    keywords:
      '新加坡智能家居, 新加坡智能家居安装, 新加坡智能家居公司, 新加坡全屋智能, 全屋智能家居, 智能家居方案, 家居自动化, 组屋智能家居, 组屋装修, BTO 智能家居, BTO 装修, 公寓智能家居, 有地住宅智能家居, 智能灯光, 智能开关, 无零线开关, 空调智能控制, 智能窗帘, 电动窗帘, 电动百叶窗, 智能门锁, 电子门锁, 监控摄像头安装, 家居安防, 能耗监测, Matter, Zigbee, Thread, 苹果家庭, Google Home, Alexa',
  ...
  platform: {
    eyebrow: '技术平台',
    title: '属于你的系统，运行在你家',
    lead: '开源软件跑在你家的控制主机上。中间没有厂商云，也不会被搬到付费墙后面。',
    points: [
      {
        title: '极广的设备覆盖',
        body: '主流品牌、空调系统、逆变器、路由器与摄像头，接入同一套系统。',
      },
      {
        title: '真正读得懂场景的自动化',
  ...
  homes: {
    ...
    areas: {
      ...
      lead: '各区域的组屋、公寓与有地住宅。',
      regions: [
        { name: '中区', towns: '碧山 · 大巴窑 · 女皇镇 · 红山 · 武吉知马 · 诺维娜' },
        { name: '东区', towns: '淡滨尼 · 勿洛 · 巴西立' },
        { name: '北区', towns: '兀兰 · 义顺 · 三巴旺' },
        { name: '东北区', towns: '榜鹅 · 盛港 · 后港 · 宏茂桥 · 实龙岗' },
        { name: '西区', towns: '裕廊 · 武吉巴督 · 蔡厝港 · 金文泰 · 武吉班让 · 登加' },
      ],
    },
  ...
  compatibility: {
    ...
    disclaimer:
      'Panda智能家居通过支持的连接方式集成兼容的第三方产品。相关产品名称及商标归各自所有，设备兼容不代表与相关品牌存在官方合作或认可关系。',
  },
  ...
  faq: {
    ...
    items: [
      {
        q: '服务覆盖新加坡哪些地区？',
        a: '全新加坡。各区域的组屋、公寓与有地住宅都可以，从榜鹅、淡滨尼到裕廊、兀兰和市区。',
      },
      {
        q: '能配合组屋和公寓的装修规定吗？',
        a: '可以。我们按建屋发展局（HDB）装修规定和公寓管理层（MCST）的要求来规划，电气工程由具备相应资质的人员施工。',
      },
      {
        q: '可以用中文沟通吗？',
        a: '可以，中文或英文都行，看你家习惯。',
      ...
      {
        q: '有月费吗？',
        a: '系统本身没有。它是开源的，运行在你家的硬件上。可选项目——你自己保留的云服务、或与我们签的支持服务——都会单独列明。',
      },
      {
        q: '家里不用App的长辈怎么办？',
